...
[`@aws-sdk/client-support`](https://www.npmjs.com/package/@aws-sdk/client-support/v/3.387.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-support@3.387.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ziiYgNO023Wh704SWLOmMtQXeMGxyh6WSerZs40ZSpRgBfXabZ1Um1R/CnnY6poG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-support": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-support@3.387.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-support@3.387.0/index.min.mjs": "sha384-ziiYgNO023Wh704SWLOmMtQXeMGxyh6WSerZs40ZSpRgBfXabZ1Um1R/CnnY6poG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-support/blob/refs/tags/3.387.0/LICENSE
```
